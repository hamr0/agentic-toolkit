...
|----------|--------------|------------------|
| **Claude Code** | `cp -r ai/subagentic/claude/* ~/.claude/` | 10 subagents + 14 skills + live-canvas-channel plugin |
| **Droid** | `cp -r ai/subagentic/droid/* ~/.factory/` | 10 subagents + 14 commands |
| **Ampcode** | `cp -r ai/subagentic/ampcode/* ~/.config/amp/` | 10 subagents + 14 skills |
| **OpenCode** | `cp -r ai/subagentic/opencode/* ~/.config/opencode/` | 10 subagents + 14 commands |
